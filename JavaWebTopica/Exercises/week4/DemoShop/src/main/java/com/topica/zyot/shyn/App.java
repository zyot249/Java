...
public class App {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            saveOrder("ORDER004", 1, 5, connection);
            connection.close();
    ...
    private static void saveOrder(String orderCode, int prodId, int quantity, Connection connection) {
        ...
        try {
            ...
            String insertOrderCus = "INSERT INTO DemoShop.order_from_customer(id, prod_id, quantity, success)" +
                    " VALUES (?, ?, ?, true);";
            statement = connection.prepareStatement(insertOrderCus);
            ...
            statement = connection.prepareStatement(getQuanInStock);
            statement.setInt(1, prodId);
            ResultSet resultSet = statement.executeQuery();
            resultSet.next();
            int quanInStock = resultSet.getInt("quan_in_stock");
            ...
            if (quantity <= quanInStock) {
                ...
                statement = connection.prepareStatement(updateQuanInStock);
                ...
                statement = connection.prepareStatement(updateOrderFail);
                statement.setString(1, orderCode);
                statement.executeUpdate();
